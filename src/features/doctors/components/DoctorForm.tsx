...
import { doctorSchema, type DoctorSchema } from "../schemas/doctor.schema";
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            <Label className="text-sm font-medium">
              <TText ns="p009" k="active" width={8} />
            </Label>

            <p className="text-xs text-muted-foreground">
              <TText ns="p009" k="doctor_availability_status" width={24} />
            </p>
          </div>
      ...
      <section className="space-y-5">
        <div className="space-y-1">
          <h2 className="text-base font-semibold tracking-tight">
            <TText ns="p009" k="basic_information" width={16} />
          </h2>

          <p className="text-sm text-muted-foreground">
            <TText ns="p009" k="basic_information_description" width={32} />
          </p>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <Field className="space-y-2" data-invalid={!!errors.genderId}>
            <FieldLabel>
              <TText ns="p009" k="gender" width={8} />
            </FieldLabel>
          ...
          <Field className="space-y-2" data-invalid={!!errors.branchId}>
            <FieldLabel>
              <TText ns="p009" k="branch" width={8} />
            </FieldLabel>
          ...
          {/* Specialty */}
          <Field className="space-y-2" data-invalid={!!errors.specialtyId}>
            <FieldLabel>
              <TText ns="p009" k="specialty_name" width={8} />
            </FieldLabel>
            ...
            {errors.specialtyId && (
              <FieldError>
                {tValidation(errors.specialtyId.message!)}
              </FieldError>
            )}
          </Field>
        </div>
      ...
      <section className="space-y-5">
        <div className="space-y-1">
          <h2 className="text-base font-semibold tracking-tight">
            <TText ns="p009" k="personal_information" width={18} />
          </h2>

          <p className="text-sm text-muted-foreground">
            <TText ns="p009" k="personal_information_description" width={28} />
          </p>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <Field className="space-y-2" data-invalid={!!errors.nationalId}>
            <FieldLabel>
              <TText ns="p009" k="national_id" width={10} />
            </FieldLabel>
          ...
          <Field className="space-y-2" data-invalid={!!errors.socialId}>
            <FieldLabel>
              <TText ns="p009" k="social_id" width={10} />
            </FieldLabel>
          ...
          <Field className="space-y-2" data-invalid={!!errors.birthDate}>
            <FieldLabel>
              <TText ns="p009" k="birth_date" width={10} />
            </FieldLabel>
          ...
          <Field className="space-y-2">
            <FieldLabel>
              <TText ns="p009" k="military_status" width={12} />
            </FieldLabel>
          ...
          <Field className="space-y-2">
            <FieldLabel>
              <TText ns="p009" k="marital_status" width={12} />
            </FieldLabel>
      ...
      <section className="space-y-5">
        <div className="space-y-1">
          <h2 className="text-base font-semibold tracking-tight">
            <TText ns="p009" k="contact_information" width={18} />
          </h2>

          <p className="text-sm text-muted-foreground">
            <TText ns="p009" k="contact_information_description" width={28} />
          </p>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <Field className="space-y-2" data-invalid={!!errors.mobile}>
            <FieldLabel>
              <TText ns="p009" k="mobile" width={8} />
            </FieldLabel>
          ...
          >
            <FieldLabel>
              <TText ns="p009" k="address" width={8} />
            </FieldLabel>
      ...
      <section className="space-y-5">
        <div className="space-y-1">
          <h2 className="text-base font-semibold tracking-tight">
            <TText ns="p009" k="location_information" width={12} />
          </h2>

          <p className="text-sm text-muted-foreground">
            <TText ns="p009" k="location_information_description" width={28} />
          </p>
        </div>
      ...
      <section className="space-y-5">
        <div className="space-y-1">
          <h2 className="text-base font-semibold tracking-tight">
            <TText ns="p009" k="additional_notes" width={16} />
          </h2>
        </div>

        <Field className="space-y-2">
          <FieldLabel>
            <TText ns="p009" k="notes" width={8} />
          </FieldLabel>
